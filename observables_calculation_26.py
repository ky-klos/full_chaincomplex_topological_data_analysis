...
def calculation_observables(data_type,output_data_path,save_basis_data=False,gen_folder= None,sim_data_type='full_pinned',larger=False,defect_nmb=2,compare_defect_lattice=False,noise_size = 1.0, training_data_nmb=350000,nmb_label = 1,new_basis_data=False,new_data=False,data_path='/localscratch/kyklos/Pytorch_cuda_code/iona/iona_oct_23/Full_training_oct_23/', epochs=[0,5,10,15,20,25,30], configuration_attributes_dict=[64,0.01,0,5,1,0],simulation_data_path  ='/localscratch/kyklos/Pytorch_cuda_code/iona/iona_oct_23/Full_training_oct_23/full_training_data_gan_low_temp_2_corrected.h5', temperature = 0.1, lattice_size= 16,further_simulated=False,samplesize=1000,rotation=False,later_rotation=True):
    with torch.no_grad():
        
        oservable_data_spins, oservable_data_defects, path_name, name_list = load_in_data_basis(temperature=temperature, lattice_size=lattice_size, device=device, data_type=data_type, simulation_data_path=simulation_data_path, sim_data_type=sim_data_type, new_data=new_basis_data, compare_defect_lattice=compare_defect_lattice, samplesize=samplesize, defect_nmb=defect_nmb, larger=larger, further_simulated=further_simulated, data_path=data_path, configuration_attributes_dict=configuration_attributes_dict, training_data_nmb=training_data_nmb, noise_size=noise_size, nmb_label=nmb_label, epochs=epochs, output_data_path=output_data_path, gen_folder=gen_folder,new=new_data)
